...
1. For the first experience, execute the file: `codes/Vector_store.py` first to import the sample student data into the vector database. Afterwards, just execute `run.py`.
